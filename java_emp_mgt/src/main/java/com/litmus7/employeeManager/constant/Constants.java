...
public class Constants {
    ...
    public static final String INSERT_EMPLOYEE = "INSERT INTO employees (emp_id, first_name, last_name, email, phone, department, salary, join_date) "
            +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    public static final String SELECT_EMPLOYEE_BY_ID = "SELECT emp_id, first_name, last_name, email, phone, department, salary, join_date FROM employees WHERE emp_id = ?";
    public static final String GET_ALL_EMPLOYEES = "SELECT emp_id, first_name, last_name, email, phone, department, salary, join_date FROM employees";
    ...
    public static final String UPDATE_DEPARTMENT = "UPDATE employees SET department = ? WHERE emp_id = ?";
}
